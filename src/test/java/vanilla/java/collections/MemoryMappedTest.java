...
public class MemoryMappedTest {
    ...
    public void testMemoryMappedBoolean() throws IOException {
        ...
        HugeArrayBuilder<MutableBooleans> hab = new HugeArrayBuilder<MutableBooleans>() {
            {
                ...
                capacity = length;
                partitionSize = 256 * 1024;
            }
        };
        final HugeList<MutableBooleans> list = hab.create();
        list.setSize(length);
        int i = 0;
        ...
        final HugeList<MutableBooleans> list2 = hab2.create();
    ...
    public void testMemoryMappedByte() throws IOException {
        ...
        final HugeList<MutableBytes> list = hab.create();
        list.setSize(length);
        int i = 0;
        ...
        final HugeList<MutableBytes> list2 = hab2.create();
        list2.setSize(length);
        int j = 0;
        for (MutableBytes mi : list) {
    ...
    public void testMemoryMappedInt() throws IOException {
        ...
        final HugeList<MutableInts> list = hab.create();
        list.setSize(length);
        int i = 0;
        ...
        final HugeList<MutableInts> list2 = hab2.create();
        list2.setSize(length);
        int j = 0;
        for (MutableInts mi : list) {
    ...
    public void testMemoryMapped2() throws IOException {
        ...
        final HugeList<MutableTypes> list = hab.create();
        list.setSize(length);
        populate(list);
        ...
        final HugeList<MutableTypes> list2 = hab2.create();
        list2.setSize(length);
        validate(list2);
        list2.close();
        ...
        final HugeList<MutableTypes> list3 = hab3.create();
