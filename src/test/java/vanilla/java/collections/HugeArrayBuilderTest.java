...
//        final long length = 128 * 1000 * 1000 * 1000L;
    ...
    public void testEnum16() {
        HugeList<MutableString> list = new HugeArrayBuilder<MutableString>() {
        }.create();
    ...
    public void testCreateTypes() throws Exception {
        ...
        HugeList<MutableTypes> hugeList0 = new HugeArrayBuilder<MutableTypes>() {{
            capacity = 1024 * 1024;
        }}.create();

        HugeList<MutableTypes> hugeList = new HugeArrayBuilder<MutableTypes>() {{
            capacity = length;
        }}.create();
    ...
    public void testAddTypes() throws Exception {
        ...
        HugeList<MutableTypes> hugeList = builder.create();
        List<MutableTypes> list = hugeList;
        assertEquals(0, list.size());
        ...
        for (int i = 0; i < elements; i++) {
            setFields(bean, i + 1);
            ((Copyable<MutableTypes>) bean2).copyFrom(bean);
    ...
    public void testCreateObjectTypes() throws Exception {
        ...
        HugeList<ObjectTypes> hugeList = new HugeArrayBuilder<ObjectTypes>() {{
            capacity = length;
        }}.create();
...
/*  @Ignore
  ...
  public void testCreateTypes2() throws Exception {
    ...
    HugeList<HT> hugeList = new HTArrayList(hab);
    List<HT> list = hugeList;
    assertEquals(0, list.size());
    ...
    exerciseList((HugeList) list, length, new HAListSetSize(hugeList));
    ...
    public void testRemoveAll() throws Exception {
        ...
        final HugeList<MutableTypes> hugeList = new HugeArrayBuilder<MutableTypes>() {{
            capacity = length;
...
*/
    ...
    public void testToStringHashCodeEquals() {
        ...
        HugeList<MutableTypes> list = new HugeArrayBuilder<MutableTypes>() {{
            capacity = size;
        }}.create();
        list.setSize(size);
        populate(list);
...
/*  private static class ArrayListSetSize implements Runnable {
    ...
    private static class HAListSetSize implements Runnable {
        private final HugeList<? extends MutableTypes> hugeList;

        public HAListSetSize(HugeList<? extends MutableTypes> hugeList) {
